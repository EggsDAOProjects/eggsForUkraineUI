...
import { ActiveChainProvider } from '../hooks';
import {
  RPC_URLS,
  supportedChains,
  defaultChainId,
...
const Header: React.FC = () => {
  ...
  if (account) {
    const first = account.slice(0,6);
    const last = account.slice(account.length - 4);
    truncatedAccount = `${first}...${last}`;
  }

  return (
    <div className="container mx-auto pt-4 px-4 md:px-0 flex justify-between relative z-10">
      <Link href="/">
