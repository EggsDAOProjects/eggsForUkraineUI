...
export class Web3ModalConnector extends AbstractConnector {
  ...
  constructor(supportedChainIds: number[], options: Partial<ICoreOptions>) {
  ...
  public async activate(): Promise<ConnectorUpdate> {
    ...
    const account = this.provider.selectedAddress ?? this.provider.accounts[0];
